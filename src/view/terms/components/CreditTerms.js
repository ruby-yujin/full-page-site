    ...
    <Container>
      ...
      <TermsListWrap>
        ...
        <ul>
          <li>
            ...
            있는 경우 또는 금융사고 조사, 분쟁해결, 민원처리, 기타 법령상 의무이행을 위해서만 신용정보를 보유,
            이용합니다.
          </li>
        </ul>
      </TermsListWrap>
      ...
      <TermsListWrap>
        ...
        <ul>
          ...
          <li>
            2. 「금융실명거래 및 비밀보장에 관한 법률」, 「신용정보의 이용 및 보호에 관한 법률」, 「금융 지주회사법」,
            「전기통신기본법」, 「전기통신사업법」, 「지방세법」, 「소비자보호법」, 「한국은행 법」, 「형사소송법」 등
            법령의 규정에 의거하여 제출을 요구하는 공공기관 및 신용정보원 등
          </li>
      ...
      <TermsListWrap>
        ...
        <ul>
          <li>① 개인신용정보 제공 동의 철회</li>
          <li>
            개인인 신용정보주체는 개인신용평가회사, 개인사업자신용평가회사 또는 신용정보집중기관에 제공하여 개인의
            신용도 등을 평가하기 위한 목적 외의 목적으로 행한 개인신용정보 제공 동의를 동의 철회의 대상 및 내용 등을
            특정하여 회사의 홈페이지, 유무선통신, 서면, 그 밖에 회사의 사무실 등을 방문하여 동의 철회서를 제출하는 방법
            등으로 철회할 수 있습니다. 단, 신용주체의 신용정보 제공은 회사와의 계약체결 및 거래관계를 위해 필수적인
            부분이므로, 신용정보 제공 동의를 철회한 경우 금융거래관계의 설정 및 유지가 불가능함을 알려드립니다.
          </li>
          <li>② 신용정보 열람 및 정정청구권</li>
          <li>
            신용정보주체는 본인임을 확인 받아 신용정보의 교부 또는 열람을 청구할 수 있으며, 본인의 신용정보가 사실과
            다를 경우에는 정정을 청구할 수 있습니다.
          </li>
          <li>③ 신용정보제공사실의 통보 요구권</li>
          <li>신용정보주체는 최근 3년간 본인에 관한 신용정보를 제공한 내역을 통보하도록 요구할 수 있습니다.</li>
          <li>④ 개인신용정보의 삭제 요구</li>
          <li>
